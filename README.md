...
**utilities**:
I selectively sync files efficiently using **[Hivemind (WIP)](https://github.com/DaDevFox/Hivemind)**, search Word and Excel files from my **[PowerToys Run Extension](https://github.com/DaDevFox/Powertoys-Office-Search)**, and 
